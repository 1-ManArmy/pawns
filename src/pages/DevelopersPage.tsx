  ...
  return (
    <div className="min-h-screen pt-28 pb-32 px-6 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <RepoGrid repos={AGENT_REPOS} baseUrl="https://github.com/onelastai" />
        ...
        <RepoGrid repos={PLATFORM_REPOS} baseUrl="https://github.com/onelastai" minimal />
...
function RepoGrid({ repos, baseUrl, minimal = false }: { repos: RepoCardData[]; baseUrl: string; minimal?: boolean }) {
  return (
